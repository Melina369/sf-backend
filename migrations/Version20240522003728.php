 ...
 */
final class Version20240522003728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subcategoria (id INT AUTO_INCREMENT NOT NULL, idsubcategoria_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, INDEX IDX_DA7FB91469CC5793 (idsubcategoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
